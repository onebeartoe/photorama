	...
	<div class="copyspace">
	    <h3>Go Spurs Show - ${model.path}</h3>
                    ...
                    <c:forEach var="directory" items="${model.directories}">
                        <div class="thumb"
                            ...
                            <a href="${pageContext.request.contextPath}/view${model.path}/${directory}">
                                <img src="${pageContext.request.contextPath}/images/folder.gif" width="100" height="100" alt="an image representing a directory on the filesystem" />
                            </a>
            ...
            <div class="featuredProject">
                ...
                <a onclick="window.history.back()" class="featuredProjectNavigation">
                                        Previous
                                </a>
                <div class="spacer">&nbsp;</div>
            </div>
